...
!function (t, e) {
    ...
    return function (t) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.compress = function (t, e, n) {
            ...
            void 0 === a && (a = !0);
            var s = n > e ? e : n, u = r, c = new ArrayBuffer(44 + t.byteLength), l = new DataView(c), f = o, p = 0;
        ...
        var r = n(2), a = n(0), s = n(3), u = function (t) {
            ...
            return o(e, t), e.prototype.setOption = function (t) {
                ...
                var t = this.getPCM(), e = t.byteLength, n = this.littleEdian, i = {left: null, right: null};
                if (2 === this.config.numChannels) {
                    var o = new DataView(new ArrayBuffer(e / 2)), r = new DataView(new ArrayBuffer(e / 2));
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(4), o = null, r = 0, a = 0, s = null, u = null, c = null, l = !1, f = 0, p = function () {
        };
